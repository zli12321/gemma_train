...
1. Accept the Gemma license at [https://huggingface.co/google/gemma-2b](https://huggingface.co/google/gemma-2b)
2. Get a HuggingFace token from [https://huggingface.co/settings/tokens](https://huggingface.co/settings/tokens)
...
4. Prompt you to log in to HuggingFace (paste your token when asked)
...
If you haven't logged in to HuggingFace yet, set your token before running:
...
| Batch size | 2 per device x 4 accumulation x 4 GPUs = 32 effective |
